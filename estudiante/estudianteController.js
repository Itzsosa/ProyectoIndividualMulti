    ...
    contenidoTablaResultado.innerHTML += `
      <tr class="table-info">
        ...
        <td>
          ...
          onClick="mostrarModificarEstudiante('${valor.id}','${valor.cedula}','${valor.nombre}','${valor.correoelectronico}','${valor.telefono}',
          '${valor.telefonocelular}','${valor.fechanacimiento}','${valor.sexo}','${valor.direccion}','${valor.apellidopaterno}',
          '${valor.apellidomaterno}','${valor.nacionalidad}',
          '${valor.idCarreras}','${valor.usuario}')"
          >Editar</button>
          <button type="button" class="btn btn-danger" onClick="mostrarModalBorrarEstudiante('${valor.id}','${valor.cedula}','${valor.nombre}','${valor.apellidopaterno}',
...
function mostrarModificarEstudiante(
  id,
  cedula,
  nombre,
  correoelectronico,
...
function mostrarModalBorrarEstudiante(
  id,
  cedula,
  nombre,
  apellidopaterno,
